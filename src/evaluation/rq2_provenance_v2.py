"""Fail-closed provenance contracts for the RQ2 public-data pipeline."""
...
PROVENANCE_CONTRACT_SCHEMA = "rq2_public_pipeline_provenance_contract_v2"
STAGE_PROVENANCE_SCHEMA = "rq2_public_stage_provenance_v2"
