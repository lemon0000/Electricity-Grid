...
_EXECUTION_CONFIG_RELATIVE = (
    "configs/rq2_joint_deliverability_execution_successor_v2.yaml"
)
...
_EXECUTION_REVIEW_RELATIVE = (
    "configs/rq2_joint_deliverability_execution_review_pass_v2.yaml"
)
...
def _load_reviewed_execution_config(
    ...
    effect = receipt.get("effect")
    if (
        receipt.get("schema") != "rq2_joint_deliverability_execution_review_pass_v2"
        ...
        or not isinstance(effect, Mapping)
        or effect.get("independent_v2_R3_review_passed") is not True
...
def stream_holdout_stage(
    *,
    ...
    raise ExecutionBlocked(
        "execution successor v2 public stage is closed pending fresh-process activation"
    )
