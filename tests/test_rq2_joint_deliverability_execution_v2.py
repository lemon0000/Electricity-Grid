...
from experiments import run_rq2_joint_deliverability_execution_v2 as runner
from experiments import (
    run_rq2_joint_deliverability_implementation_v2 as implementation_runner,
)
from experiments import (
    validate_rq2_joint_deliverability_execution_v2 as validator,
)
from src.rq2_joint_deliverability_execution_v2 import core
from src.rq2_joint_deliverability_execution_v2.core import (
    EvidenceDrift,
    EvidenceStore,
    ExecutionBlocked,
...
CONFIG = ROOT / "configs/rq2_joint_deliverability_execution_successor_v2.yaml"
...
def test_validator_binds_v1_rework_predecessor(
    section: str,
    key: str,
    replacement: object,
) -> None:
...
def test_public_stage_entries_require_sealed_live_input_authority(
    tmp_path: Path,
) -> None:
    for entry in (
    ...
    with pytest.raises(
        ExecutionEvidenceError,
        match="required path is absent",
    ):
        core._load_live_registered_inputs()
...
def test_public_stage_rejects_caller_supplied_unbound_grid_digest(
    tmp_path: Path,
    monkeypatch: pytest.MonkeyPatch,
) -> None:
...
def test_execution_review_receipt_is_the_fixed_outer_authority(
    ...
    inner_payload = {
        "schema": "rq2_joint_deliverability_execution_inner_v2",
        "version": 2,
        "files": {
...
def test_validate_only_runner_supports_direct_script_invocation() -> None:
    completed = subprocess.run(
        [
            sys.executable,
            str(ROOT / "experiments/run_rq2_joint_deliverability_execution_v2.py"),
            "--validate-only",
        ],
        cwd=ROOT,
        check=True,
...
import experiments.run_rq2_joint_deliverability_execution_v2  # noqa: F401
...
"""
    ...
    expected = {
        ...
        "experiments/run_rq2_joint_deliverability_execution_v2.py",
        "experiments/validate_rq2_joint_deliverability_execution_v2.py",
        "src/__init__.py",
        "src/rq2_joint_deliverability_execution_v2/__init__.py",
        "src/rq2_joint_deliverability_execution_v2/core.py",
