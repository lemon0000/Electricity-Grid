...
本文件是v3路线的provenance successor。v3科学设计保持不变；本版只修复
R4复审发现的跨checkpoint/package身份链缺口。
...
- 每个v2 stage从同一冻结provenance contract加载runner、直接模型模块和
...
3. v4 provenance successor尚需独立R4审查；
4. 用户尚未单独授权正式长运行。
