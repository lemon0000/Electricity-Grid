# RQ2 joint-deliverability fresh-process activation successor v3
...
- activation v2 official ESCALATE receipt
...
The activation v3 review receipt remains outside the reviewed outer to avoid a
...
`bootstrap_rq2_joint_deliverability_activation_v3.py` imports only Python
...
5. recursively verify activation v2 outer and its ESCALATE receipt;
...
12. install a private in-memory loader for the envelope's verified local source
   ...
   v3;
13. revalidate activation v2 and execution v3 authority and confirm registered
    inputs remain
   non-ready;
