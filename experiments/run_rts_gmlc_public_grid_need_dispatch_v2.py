...
def run(
    ...
    *,
    ...
    if validate_only:
        return {
            "schema": "rts_gmlc_public_grid_need_dispatch_preflight_v2",
    ...
    for block_id in sorted(blocks):
        ...
        if checkpoint_path.exists():
            ...
            if (
                ...
                != "rts_gmlc_public_grid_need_block_checkpoint_v2"
                or any(
        ...
        checkpoint = {
            "schema": "rts_gmlc_public_grid_need_block_checkpoint_v2",
            "stage_base_provenance_sha256": stage_base_sha256,
            **result,
        }
...
def main() -> None:
    ...
    parser.add_argument(
        "--config",
        type=Path,
        default=Path("configs/rts_gmlc_public_grid_need_dispatch_v2.yaml"),
    )
