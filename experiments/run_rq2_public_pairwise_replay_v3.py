...
_STAGE = "pairwise_replay_v3"
_GRID_STAGE = "grid_need_dispatch_v3"
_POLICY_FIELDS = (
    "cell_id",
    "varied_dimension",
    "variant",
...
def _preflight(config_path: Path) -> tuple[dict[str, Any], dict[str, object]]:
    ...
    report = {
        "schema": "rq2_public_pairwise_replay_preflight_v3",
    ...
    *,
    ...
    for cell in cells:
        ...
        checkpoint = _load_checkpoint(
            ...
            schema="rq2_public_policy_checkpoint_v3",
        )
        ...
        for power in power_holdout:
            for workload in workload_holdout:
                ...
                checkpoint = _load_checkpoint(
                    path,
                    pair_identity,
                    schema="rq2_public_pair_checkpoint_v3",
                )
                if checkpoint is None:
                ...
                if maximum_pairs is not None and processed >= maximum_pairs:
                    return {
                        "schema": "rq2_public_pairwise_replay_progress_v3",
...
def main() -> None:
    ...
    parser.add_argument(
        "--config",
        type=Path,
        default=Path("configs/rq2_public_pairwise_replay_v3.yaml"),
    )
