"""V6 lifecycle bootstrap with production wiring behind fail-closed gates."""
...
def validate_only() -> dict[str, Any]:
    ...
    return {
        "schema": (
            "rq2_public_grid_highs_formal_activation_validation_v6_sealed"
            if sealed
            else "rq2_public_grid_highs_formal_activation_validation_v6_draft"
        ),
...
def _execute_preseal_startup_probe(
    ...
    *,
    ...
    return {
        "schema": "rq2_v6_preseal_real_startup_probe",
