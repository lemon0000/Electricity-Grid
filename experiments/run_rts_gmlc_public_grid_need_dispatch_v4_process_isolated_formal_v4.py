...
from experiments import (
    rq2_public_grid_highs_formal_activation_contract_v3 as authority,
)
from experiments import (
...
MODULE = (
    "experiments."
    "run_rts_gmlc_public_grid_need_dispatch_v4_process_isolated_formal_v4"
)
REQUEST_SCHEMA = "rq2_grid_need_process_isolated_worker_request_formal_v4"
RELEASE_SCHEMA = "rq2_grid_need_process_isolated_worker_release_formal_v4"
...
def _require_consumed_controller_authority(dynamic_authority: Path) -> dict[str, Any]:
    ...
    if (
        ...
        != "rq2_public_grid_highs_formal_activation_successor_v3_consumed_authority"
...
def _dispatch_one(
    ...
    *,
    ...
    controller_receipt = {
        "schema": "rq2_grid_need_process_isolated_attempt_formal_v4",
        "block_id": block_id,
        "request_sha256": authority.sha256_file(request_path),
