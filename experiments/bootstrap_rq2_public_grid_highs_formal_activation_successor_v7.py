"""V7 lifecycle bootstrap with production wiring behind fail-closed gates."""
...
def validate_only() -> dict[str, Any]:
    ...
    return {
        "schema": (
            "rq2_public_grid_highs_formal_activation_validation_v7_sealed"
            if sealed
            else "rq2_public_grid_highs_formal_activation_validation_v7_draft"
        ),
...
def _execute_preseal_startup_probe(
    ...
    *,
    ...
    return {
        "schema": "rq2_v7_preseal_real_startup_probe",
