...
from experiments.validate_rq2_joint_deliverability_execution_v2 import (
...
def validate_runtime_contract(config: Mapping[str, object]) -> None:
    if config.get("schema") != "rq2_joint_deliverability_execution_successor_v2":
...
def run(*, validate_only: bool = True) -> dict[str, object]:
    ...
    return {
        "schema": "rq2_joint_deliverability_execution_validation_v2",
