"""Static fail-closed validator for the RQ2 execution successor v2."""
...
CONFIG_RELATIVE = "configs/rq2_joint_deliverability_execution_successor_v2.yaml"
CORE_RELATIVE = "src/rq2_joint_deliverability_execution_v2/core.py"
RUNNER_RELATIVE = "experiments/run_rq2_joint_deliverability_execution_v2.py"
VALIDATOR_RELATIVE = "experiments/validate_rq2_joint_deliverability_execution_v2.py"
TEST_RELATIVE = "tests/test_rq2_joint_deliverability_execution_v2.py"
ARCHITECTURE_RELATIVE = "docs/model_spec/rq2_joint_deliverability_execution_v2.md"
INNER_RELATIVE = (
    "configs/rq2_joint_deliverability_execution_successor_v2.SHA256SUMS.json"
)
OUTER_RELATIVE = (
...
EXPECTED_PREDECESSOR_AUTHORITY = {
    "execution_outer": {
        ...
        "sha256": "1ec234a1279b1c5a09b2beedb66ec1dfffcda28ed4a024df44d7d47060c976d2",
    },
    "official_review": {
        "path": "configs/rq2_joint_deliverability_execution_review_rework_v1.yaml",
        "sha256": "9188549f0fc87b7094ff6f1422a36e36ee45718338aa4bc9230edcfee47ede5a",
        "verdict": "REWORK",
        "blocker_findings": 0,
        "major_findings": 1,
        "minor_findings": 0,
...
EXPECTED_EXECUTION_REVIEW_AUTHORITY = {
    ...
    "schema": "rq2_joint_deliverability_execution_review_pass_v2",
    "review_scope": "rq2_joint_deliverability_execution_successor_v2_exact_outer",
    "reviewer_role": "independent_sol_reviewer",
    "required_verdict": "PASS",
    "required_effect": {
        "independent_v2_R3_review_passed": True,
...
EXPECTED_EXECUTION_RUNTIME_AUTHORITY = {
    "path": (
        "results/execution_configs/rq2_joint_deliverability_execution_v2/"
        "runtime_receipt.json"
    ),
    "schema": "rq2_joint_deliverability_execution_runtime_receipt_v2",
    "sha256": None,
    "ready": False,
}
EXPECTED_EXECUTION_ACTIVATION_AUTHORITY = {
    "path": "configs/rq2_joint_deliverability_execution_activation_pass_v2.yaml",
    "schema": "rq2_joint_deliverability_execution_activation_pass_v2",
    "sha256": None,
    "ready": False,
}
...
EXPECTED_MEMBERS = {
    ...
    "src/rq2_joint_deliverability_execution_v2/__init__.py",
    "src/__init__.py",
...
def _validate_predecessor_authority(config: dict[str, Any]) -> None:
    ...
    if (
        outer.get("schema") != "rq2_joint_deliverability_execution_outer_v1"
    ...
    if (
        inner.get("schema") != "rq2_joint_deliverability_execution_inner_v1"
    ...
    receipt = _load_yaml(review_path)
    ...
    if (
        receipt.get("schema") != "rq2_joint_deliverability_execution_review_rework_v1"
        ...
        or receipt.get("verdict") != review_item["verdict"]
        ...
        or effect.get("v1_bytes_immutable") is not True
        or effect.get("independent_v1_R3_review_passed") is not False
        or effect.get("one_focused_versioned_successor_allowed") is not True
...
def _validate_contracts(config: dict[str, Any]) -> None:
    ...
    if config.get("validation_contract") != {
        "focused_test_command": (
            "python -m pytest -q tests/test_rq2_joint_deliverability_execution_v2.py"
        ),
        "solver_calls": 0,
...
def _validate_manifest(require_sealed: bool) -> None:
    ...
    if (
        ...
        or inner.get("schema") != "rq2_joint_deliverability_execution_inner_v2"
    ...
    if outer != {
        "schema": "rq2_joint_deliverability_execution_outer_v2",
        "version": 2,
        "inner": {
            "path": INNER_RELATIVE,
...
def validate(
    ...
    *,
    ...
    if (
        config["schema"] != "rq2_joint_deliverability_execution_successor_v2"
        or config["version"] != 2
    ...
    return {
        "schema": "rq2_joint_deliverability_execution_static_validation_v2",
        "valid": True,
