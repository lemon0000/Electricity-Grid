...
def validate_only() -> dict[str, Any]:
    ...
    return {
        "schema": "rq2_public_grid_highs_formal_activation_validation_v3",
...
def _record_post_release_unresolved(
    ...
    *,
    ...
    roots = dict(formal_roots_override or contract.formal_roots())
    root_observations = {
        name: _observe_root(path) for name, path in sorted(roots.items())
    }
    release_sha256 = (
        contract.sha256_file(release_path)
        if release_path.is_file() and not release_path.is_symlink()
        else None
    )
    outcome = {
        "schema": "rq2_public_grid_highs_formal_post_release_unresolved_v3",
        "version": 3,
        "wall_time_ns": time.time_ns(),
        "monotonic_ns": time.monotonic_ns(),
        "phase": "post_science_release",
        "reason": reason,
        "release_persisted": release_sha256 is not None,
        ...
        "controller_process_observed_live": returncode is None,
        ...
        "related_formal_process_observations": contract.related_formal_processes(),
        "solver_process_observation_scope": "best_effort_command_line_contains_highs",
        "solver_process_observations": contract._powershell_related_processes("highs"),
...
def _record_launch_incomplete(
    ...
    *,
    ...
    outcome = {
        "schema": "rq2_public_grid_highs_formal_launch_incomplete_v3",
        "version": 3,
        "wall_time_ns": time.time_ns(),
        "monotonic_ns": time.monotonic_ns(),
        "phase": phase,
...
def _spawn_controller(
    ...
    *,
    ...
    try:
        ...
        raise
    spawn = {
        "schema": "rq2_public_grid_highs_formal_activation_spawn_receipt_v3",
        "version": 3,
...
def execute() -> dict[str, Any]:
    ...
    return {
        "schema": "rq2_public_grid_highs_formal_activation_bootstrap_result_v3",
