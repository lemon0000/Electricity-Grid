"""Static fail-closed validator for the RQ2 execution successor v1."""
...
RUNNER_RELATIVE = "experiments/run_rq2_joint_deliverability_execution_v1.py"
VALIDATOR_RELATIVE = "experiments/validate_rq2_joint_deliverability_execution_v1.py"
TEST_RELATIVE = "tests/test_rq2_joint_deliverability_execution_v1.py"
ARCHITECTURE_RELATIVE = "docs/model_spec/rq2_joint_deliverability_execution_v1.md"
INNER_RELATIVE = (
...
EXPECTED_EXECUTION_REVIEW_AUTHORITY = {
    "path": "configs/rq2_joint_deliverability_execution_review_pass_v1.yaml",
...
EXPECTED_EXECUTION_RUNTIME_AUTHORITY = {
    "path": (
        "results/execution_configs/rq2_joint_deliverability_execution_v1/"
        "runtime_receipt.json"
    ),
    "schema": "rq2_joint_deliverability_execution_runtime_receipt_v1",
    "sha256": None,
    "ready": False,
}
EXPECTED_EXECUTION_ACTIVATION_AUTHORITY = {
    "path": "configs/rq2_joint_deliverability_execution_activation_pass_v1.yaml",
    "schema": "rq2_joint_deliverability_execution_activation_pass_v1",
    "sha256": None,
    "ready": False,
}
...
def _validate_contracts(config: dict[str, Any]) -> None:
    ...
    if config.get("validation_contract") != {
        "focused_test_command": (
            "python -m pytest -q tests/test_rq2_joint_deliverability_execution_v1.py"
        ),
        "solver_calls": 0,
...
def _validate_manifest(require_sealed: bool) -> None:
    ...
    if (
        ...
        or inner.get("schema") != "rq2_joint_deliverability_execution_inner_v1"
...
def validate(
    ...
    *,
    ...
    if (
        config["schema"] != "rq2_joint_deliverability_execution_successor_v1"
        or config["version"] != 1
    ...
    return {
        "schema": "rq2_joint_deliverability_execution_static_validation_v1",
        "valid": True,
