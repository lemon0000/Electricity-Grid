...
def run(
    ...
    *,
    ...
    if validate_only:
        return {
            "schema": "rts_gmlc_public_grid_need_dispatch_preflight_v3",
    ...
    for block_id in sorted(blocks):
        ...
        if checkpoint_path.exists():
            ...
            if (
                ...
                != "rts_gmlc_public_grid_need_block_checkpoint_v3"
                or any(
        ...
        checkpoint = {
            "schema": "rts_gmlc_public_grid_need_block_checkpoint_v3",
            "stage_base_provenance_sha256": stage_base_sha256,
            **result,
        }
        ...
        if maximum_blocks is not None and processed >= maximum_blocks:
            return {
                "schema": "rts_gmlc_public_grid_need_dispatch_progress_v3",
...
def main() -> None:
    ...
    parser.add_argument(
        "--config",
        type=Path,
        default=Path("configs/rts_gmlc_public_grid_need_dispatch_v3.yaml"),
    )
