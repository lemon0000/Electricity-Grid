"""Static validator for RQ2 joint-deliverability activation v3."""
...
from experiments import bootstrap_rq2_joint_deliverability_activation_v3 as bootstrap
...
EXPECTED_BUNDLE_MEMBERS = {
    ...
    "configs/rq2_joint_deliverability_activation_successor_v3.json",
    ...
    "docs/model_spec/rq2_joint_deliverability_activation_v3.md",
    ...
    "experiments/run_rq2_joint_deliverability_implementation_v2.py",
    "experiments/validate_rq2_joint_deliverability_activation_v3.py",
    ...
    "tests/test_rq2_joint_deliverability_activation_v3.py",
}
...
def _validate_contract(config: Mapping[str, object]) -> None:
    ...
    if scope != {
        ...
        "remediation_scope": "activation_v2_close_error_resource_ownership",
    ...
    if validation != {
        ...
        "close_recovery_max_retries_after_generation_proof": 1,
        "same_generation_retry_requires_error_free_probe": True,
        "any_probe_error_forces_indeterminate": True,
        "numeric_liveness_is_generation_proof": False,
        "cleanup_preserves_primary_failure": True,
        "windows_probe_outcome_mapping": {
            "successful_liveness_query": "indeterminate",
            "error_invalid_handle": "closed",
            "other_win32_error": "indeterminate",
        },
        "cleanup_outcome_statuses": [
            "closed",
            "unresolved",
            "indeterminate",
        ],
        "explicit_leaf_descriptor_ownership_required": True,
        "implicit_fdopen_ownership_allowed": False,
        "cleanup_result_checked_on_all_paths": True,
        "windows_behavioral_fault_injection_required": True,
...
def validate(
    ...
    *,
    ...
    return {
        "schema": "rq2_joint_deliverability_activation_static_validation_v3",
