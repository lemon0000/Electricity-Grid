...
def _preflight(config_path: Path) -> tuple[dict[str, Any], dict[str, object]]:
    ...
    report = {
        "schema": "rq2_public_identification_grid_preflight_v1",
    ...
    return config, {"package": package, "report": report, "summary": summary}
...
def main() -> None:
    ...
    parser.add_argument(
        "--config",
        type=Path,
        default=Path("configs/rq2_public_identification_grid_v1.yaml"),
    )
